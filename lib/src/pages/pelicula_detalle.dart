...
class PeliculaDetalle extends StatelessWidget {
  ...
  Widget _crearAppBar(Pelicula pelicula) {
    ...
    String titleMovie = pelicula.title;

    if (titleMovie.length > 28){
      titleMovie = '  ' + titleMovie.substring(0, 28) + '...  ';
    }
    else{
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        centerTitle: true,
        title: Text(titleMovie, style: TextStyle(color: Colors.white, fontSize: 16.0)),
